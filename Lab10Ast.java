...
public class Lab10Ast extends Applet
{
    ...
    public void paint(Graphics g)
    {
        ...
        flagOfBaryia(g);
        flagOfMauritius(g);
        flagOfNavalSignalDivision(g);
        flagOfNavalSignalCharlie(g);
        flagOfElstGelderland(g);
        flagOfPowiatWodzislawski(g);
    }
    ...
    {
        Expo.setBackground(g,Expo.lightGray);
        for (int d = 1; d<= numDots; d++)
        {
    ...
    public static void flagOfHolland (Graphics g)
    {
        ...
        for (int d = 1; d <= numDots; d++)
        {
            int x = Expo.random(0,1000); // random x valure of each dot
            int y = Expo.random(0,650); // random y value of each dot
    ...
    public static void flagOfLithuania (Graphics g)
	{
	    ...
	    for (int d = 1; d <= numDots; d++)
		{
			...
			if (y < 225)                       // top stripe
				Expo.setColor(g,Expo.yellow);
			if (y >=225 && y < 450)		   // middle stripe
				Expo.setColor(g,Expo.green);
			if (y > 445)                    //bottom stripe
			    Expo.setColor(g,Expo.red);
    ...
    public static void flagOfBaryia (Graphics g)
	{
	    Expo.setBackground(g,Expo.lightGray);
	    for (int d = 1; d <= numDots; d++)
		{
			...
			if (y <162.5)                  // top stripe
				Expo.setColor(g,Expo.red);
			if (y >=162.5 && y < 325)		   // middle stripe
				Expo.setColor(g,Expo.white);
			if (y >=325 && y < 487.5)	       //middle stripe
			    Expo.setColor(g,Expo.red);
			if (y > 487.5)                // botom stripe
			    Expo.setColor(g,Expo.white);
    ...
    public static void flagOfNavalSignalDivision (Graphics g)
	{
	    Expo.setBackground(g,Expo.lightGray);
	    for (int d = 1; d <= numDots; d++)
		{
		...
		showName(g,"Naval. Signal: Division");
    }
    
     public static void flagOfNavalSignalCharlie (Graphics g)
	{
	    Expo.setBackground(g,Expo.lightGray);
	    for (int d = 1; d <= numDots; d++)
		{
			...
			if (y <130)                  // top stripe
				Expo.setColor(g,Expo.darkBlue);
			if (y >=130 && y < 260)		   // middle stripe
				Expo.setColor(g,Expo.white);
			if (y >=260 && y < 390)	       //middle stripe
			    Expo.setColor(g,Expo.red);
			if (y >=390 && y < 520)	       //middle stripe
			    Expo.setColor(g,Expo.white);
			if (y > 520)                // botom stripe
			    Expo.setColor(g,Expo.darkBlue);

			drawDot(g,x,y);
		}
		showName(g,"Naval. Signal: Charlie 'C'");
    }
    
     public static void flagOfElstGelderland (Graphics g)
	{
	    Expo.setBackground(g,Expo.lightGray);
	    for (int d = 1; d <= numDots; d++)
		{
		...
		showName(g,"Elst. Gerderland");
    }
    
      public static void flagOfPowiatWodzislawski (Graphics g)
	{
	    Expo.setBackground(g,Expo.lightGray);
	    for (int d = 1; d <= numDots; d++)
		{
		...
		showName(g,"Powait Wodzislawski");
    }
